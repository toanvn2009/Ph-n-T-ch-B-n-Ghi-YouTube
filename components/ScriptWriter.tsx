                ...
                {versions.map((version) => (
                    <div key={version.id} className="flex items-center justify-between bg-slate-700/50 p-2 rounded hover:bg-slate-700 transition-colors">
                        <div className="flex items-center gap-3">
                            <button onClick={() => audio.handlePlayVersion(version)} className={`p-2 rounded-full shadow-inner transition-all duration-200 ${audio.audioPlayingId === version.id ? `bg-${accentColor}-500 text-white scale-110` : 'bg-slate-600 text-slate-300 hover:text-white hover:bg-slate-500'}`}>{audio.audioPlayingId === version.id ? <PauseIcon /> : <PlayIcon />}</button>
                        ...
                        <div className="flex items-center gap-2">
                            <button onClick={() => audio.handleDownloadAudioVersion(version, index, prefix)} className="p-2 text-slate-400 hover:text-green-400 hover:bg-slate-600 rounded transition-colors" title="Tải xuống"><DownloadIcon /></button>
                            <button onClick={() => audio.handleDeleteVersion(uniqueKey, version.id)} className="p-2 text-slate-400 hover:text-red-400 hover:bg-slate-600 rounded transition-colors" title="Xóa"><TrashIcon /></button>
                        </div>
                    </div>
                ))}
            </div>
